...
OhdsiRTools::checkUsagePackage("EHDENUseCase5.3CCISex")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase5.3CCISex.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase5.3CCISex.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENUseCase5.3CCISex")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase5.3CCISex",
                                mode = "description",
