...
OhdsiRTools::checkUsagePackage("EHDENUseCase6.4CCISex")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase6.4CCISex.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase6.4CCISex.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENUseCase6.4CCISex")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase6.4CCISex",
                                mode = "description",
