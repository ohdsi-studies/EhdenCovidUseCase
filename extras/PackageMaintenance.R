...
OhdsiRTools::checkUsagePackage("EHDENUseCase3.2")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase3.2.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase3.2.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase3.2",
                                mode = "description",
