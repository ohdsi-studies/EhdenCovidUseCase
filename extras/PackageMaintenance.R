...
OhdsiRTools::checkUsagePackage("EHDENCovidUseCaseCD")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENCovidUseCaseCD.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENCovidUseCaseCD.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENCovidUseCaseCD")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENCovidUseCaseCD",
                                mode = "description",
