...
OhdsiRTools::checkUsagePackage("EHDENUseCase7.2RemTocNoSubgroupsCCISex")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase7.2RemTocNoSubgroupsCCISex.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase7.2RemTocNoSubgroupsCCISex.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENUseCase7.2RemTocNoSubgroupsCCISex")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase7.2RemTocNoSubgroupsCCISex",
                                mode = "description",
