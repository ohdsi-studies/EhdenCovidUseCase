...
OhdsiRTools::checkUsagePackage("EHDENUseCase4.3")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase4.3.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase4.3.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase4.3",
                                mode = "description",
