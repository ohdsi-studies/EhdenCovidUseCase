...
OhdsiRTools::checkUsagePackage("EHDENUseCaseNICE")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCaseNICE.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCaseNICE.pdf")
...
OhdsiRTools::createRenvLockFile("EHDENUseCaseNICE")
