...
OhdsiRTools::checkUsagePackage("EHDENCOVIDUseCase")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENCOVIDUseCase.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENCOVIDUseCase.pdf")
...
OhdsiRTools::createRenvLockFile("EHDENCOVIDUseCase")
