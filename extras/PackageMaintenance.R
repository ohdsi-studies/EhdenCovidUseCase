...
OhdsiRTools::checkUsagePackage("EHDENUseCase8")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase8.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase8.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase8",
                                mode = "description",
