...
OhdsiRTools::checkUsagePackage("EHDENUseCase6.2NoPS")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase6.2NoPS.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase6.2NoPS.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENUseCase6.2NoPS")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase6.2NoPS",
                                mode = "description",
