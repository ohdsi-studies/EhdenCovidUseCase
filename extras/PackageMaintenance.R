...
OhdsiRTools::checkUsagePackage("EHDENUseCase7.1RemTocNoSubgroups")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase7.1RemTocNoSubgroups.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase7.1RemTocNoSubgroups.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENUseCase7.1RemTocNoSubgroups")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase7.1RemTocNoSubgroups",
                                mode = "description",
