...
OhdsiRTools::checkUsagePackage("StudyPackage")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/StudyPackage.pdf")
shell("R CMD Rd2pdf ./ --output=extras/StudyPackage.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "StudyPackage",
                                mode = "description",
