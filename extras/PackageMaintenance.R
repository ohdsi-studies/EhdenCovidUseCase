...
OhdsiRTools::checkUsagePackage("EHDENCOVIDUseCase2")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENCOVIDUseCase2.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENCOVIDUseCase2.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENCOVIDUseCase2")
...
OhdsiRTools::createRenvLockFile("EHDENCOVIDUseCase2")
