...
OhdsiRTools::checkUsagePackage("EHDENUseCase9")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase9.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase9.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase9",
                                mode = "description",
