...
OhdsiRTools::checkUsagePackage("EHDENUseCase6.1RemToc")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase6.1RemToc.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase6.1RemToc.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENUseCase6.1RemToc")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase6.1RemToc",
                                mode = "description",
