...
OhdsiRTools::checkUsagePackage("EHDENUseCase5.2AgeSex")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase5.2AgeSex.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase5.2AgeSex.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENUseCase5.2AgeSex")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase5.2AgeSex",
                                mode = "description",
