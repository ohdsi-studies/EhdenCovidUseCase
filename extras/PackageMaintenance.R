...
OhdsiRTools::checkUsagePackage("EHDENUseCase6.5full")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase6.5full.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase6.5full.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase6.5full",
                                mode = "description",
