...
OhdsiRTools::checkUsagePackage("EHDENUseCase5.1NoPS")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase5.1NoPS.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase5.1NoPS.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENUseCase5.1NoPS")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase5.1NoPS",
                                mode = "description",
