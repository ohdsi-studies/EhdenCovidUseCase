...
OhdsiRTools::checkUsagePackage("EHDENUseCase6.3AgeSex")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase6.3AgeSex.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase6.3AgeSex.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENUseCase6.3AgeSex")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase6.3AgeSex",
                                mode = "description",
