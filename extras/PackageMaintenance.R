...
OhdsiRTools::checkUsagePackage("EHDENCOVIDUseCase3")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENCOVIDUseCase3.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENCOVIDUseCase3.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENCOVIDUseCase3")
...
OhdsiRTools::createRenvLockFile("EHDENCOVIDUseCase3")
