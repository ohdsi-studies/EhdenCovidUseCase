...
OhdsiRTools::checkUsagePackage("EHDENUseCase7.3RemTocNoSubgroupsAgeSex")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase7.3RemTocNoSubgroupsAgeSex.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase7.3RemTocNoSubgroupsAgeSex.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "Cohorts.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "EHDENUseCase7.3RemTocNoSubgroupsAgeSex")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase7.3RemTocNoSubgroupsAgeSex",
                                mode = "description",
