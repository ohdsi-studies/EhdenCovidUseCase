...
OhdsiRTools::checkUsagePackage("EHDENUseCase4.2")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/EHDENUseCase4.2.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EHDENUseCase4.2.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "EHDENUseCase4.2",
                                mode = "description",
