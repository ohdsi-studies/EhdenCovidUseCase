...
This version contains comparisons of Remdesivir vs Tocilizumab in patients with and without corticosteroid use. 
...
2. Create an empty folder or new RStudio project, and in `R`, use the following code to install the study package and its dependencies:
    ...
    download.file("https://raw.githubusercontent.com/ohdsi-studies/EhdenCovidUseCase/EHDENUseCase9CorticostoeroidsOnly/renv.lock", "renv.lock")
    renv::init()
    ```  
